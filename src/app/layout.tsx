...
export const metadata: Metadata = {
  title: "HHH - Personalized Healthcare Navigation & Patient Advocacy",  description: "Professional healthcare coordination services. Insurance assistance, medical terminology translation, claim appeals, and patient advocacy support. Empowering your healthcare journey.",  keywords: "healthcare advocacy, patient support, insurance assistance, medical navigation, concierge care, healthcare coordination",  metadataBase: new URL("https://hhheather.com"),
  alternates: {
    canonical: "https://hhheather.com"},
  openGraph: {
    title: "HHH - Personalized Healthcare Assistance",    description: "Navigate your healthcare journey with professional coordination and personalized support services.",    type: "website",    siteName: "HHH"},
  twitter: {
    card: "summary_large_image",    title: "HHH - Healthcare Patient Advocacy",    description: "Professional healthcare navigation and patient support services"},
  robots: {
    index: true,
    follow: true,
  },
